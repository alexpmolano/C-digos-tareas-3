...
# Cargar el dataset (ajustar la ruta según corresponda)
...
X = data[['name', 'year','km_driven', 'fuel','seller_type','owner',  ]]  # Reemplaza con los nombres de las columnas relevantes
